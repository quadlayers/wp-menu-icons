...
export default function NewLibrary({ onClose }) {
    ...
    return <div id={WPMI_PREFIX + '_modal_new_library'}>
        <button
            type="button"
        ...
        <div class="media-frame mode-select wp-core-ui hide-menu">
            ...
            <div class="media-modal-content">
                <div class="media-frame mode-select wp-core-ui display-flex-center" style={{ backgroundColor: '#f5f7f9' }}>
                    <div
                        class="container-drop-zone"
                        onClick={dropZoneOnClick}
                    >
                        <DropZone
                            onFilesDrop={uploadLibrary}
                        />
                        ...
                        <div class="drop-zone display-flex-center">
                            ...
                            <span>{__('Drag & Drop to Upload File', 'wp-menu-icons')}</span>

                            <input
                                ref={inputRef}
                                type="file"
                                accept="zip,application/octet-stream,application/zip,application/x-zip,application/x-zip-compressed"
                                onChange={e => uploadLibrary(e.target.files)}
                                multiple={false}
                            />
