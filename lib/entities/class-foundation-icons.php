...
class Foundation_Icons extends Entity_Base implements Entity_Interface {

	public function __construct() {
		parent::__construct();
		$this->name            = 'foundation';
		$this->label           = 'Foundation Icons';
		$this->version         = '1.0.0';
		$this->stylesheet_file = plugins_url( 'assets/frontend/icons/foundation/foundation-icons.min.css', WPMI_PLUGIN_FILE );
