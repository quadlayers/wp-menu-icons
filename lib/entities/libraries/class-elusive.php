...
class Elusive extends Library_Base implements Library_Interface {

	public function __construct() {
		$this->name                = 'elusive';
		$this->label               = 'Elusive';
		$this->stylesheet_file_url = plugins_url( 'assets/frontend/icons/elusive/css/elusive-icons.min.css', WPMI_PLUGIN_FILE );
