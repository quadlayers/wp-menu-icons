					...
					<div className="welcome-header">
						...
						<div className="about-description">
							<p>
								{ sprintf(
									__(
										"Hello! We are Quadlayers, and we're currently enhancing our %s product. We're expanding its features to provide you with an even better experience. Stay tuned for the updates!",
										'wp-menu-icons'
									),
									WPMI_PLUGIN_NAME
								) }
